...
class RowReduce{
    ...
    public:
        ...
        std::vector<uint8_t>& fast_solve(std::vector<uint8_t> y_vec, std::vector<int>& cols = NULL_INT_VECTOR, std::vector<int>& rows = NULL_INT_VECTOR){
            ...
            for(int j = 0; j<this->U.n; j++){
                ...
                // std::cout<<"y: "<<std::endl;
                // ldpc::sparse_matrix_util::print_sparse_matrix(y);
                // std::cout<<std::endl;

                // ldpc::sparse_matrix_util::print_sparse_matrix(this->U);

                // std::cout<<std::endl;

                // ldpc::sparse_matrix_util::print_sparse_matrix(this->L);
...
//cython helper
ldpc::sparse_matrix_base::CsrMatrix cy_row_complement_basis(ldpc::gf2sparse::GF2Sparse<ldpc::gf2sparse::GF2Entry>* mat){
