...
const vector<double> NULL_DOUBLE_VECTOR = {};

vector<int> sort_indices(std::vector<double>& B){
...
struct cluster{
    ...
    vector<int> candidate_bit_nodes;
    ...
    vector<int> cluster_decoding;
    vector<int> matrix_to_cluster_bit_map;
    tsl::robin_map<int,int> cluster_to_matrix_bit_map;
    vector<int> matrix_to_cluster_check_map;
    ...
    void get_candidate_bit_nodes(){
        ...
        vector<int> erase_boundary_check;
        this->candidate_bit_nodes.clear();
    ...
    int grow_cluster(const vector<double>& bit_weights = NULL_DOUBLE_VECTOR, int bits_per_step = 0){
        ...
        if(bit_weights == NULL_DOUBLE_VECTOR){
            ...
            vector<double> cluster_bit_weights;
    ...
    vector<int> peel_decode(const vector<uint8_t>& syndrome){
        vector<int> erasure;
    ...
    // vector<int> bposd_decode(const vector<uint8_t>& syndrome){
...
class uf_decoder{
    ...
    public:
        ...
        vector<uint8_t>& peel_decode(const vector<uint8_t>& syndrome, const vector<double>& bit_weights = NULL_DOUBLE_VECTOR, int bits_per_step = 1){

            fill(this->decoding.begin(), this->decoding.end(), 0);

            vector<cluster*> clusters;
            vector<cluster*> invalid_clusters;
        ...
        vector<uint8_t>& matrix_decode(const vector<uint8_t>& syndrome, const vector<double>& bit_weights = NULL_DOUBLE_VECTOR, int bits_per_step = 1){
        ...
        // vector<uint8_t>& bposd_decode(const vector<uint8_t>& syndrome, const vector<double>& bit_weights = NULL_DOUBLE_VECTOR, int bits_per_step = 1){
