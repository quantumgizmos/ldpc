...
error_rate = 0.25
H = rep_code(1000)
bpd=BpDecoder(H, error_rate=error_rate, bp_method='ps', schedule = "parallel", ms_scaling_factor=0.90, max_iter=20,omp_thread_count=1, random_schedule_seed = 0)
bpd_v1=bp_decoder_v1(H, error_rate=error_rate, bp_method='ps_log', ms_scaling_factor=0.90, max_iter=20)
