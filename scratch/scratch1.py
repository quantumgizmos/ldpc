...
McSim(H, error_rate=error_rate, Decoder=bpd, target_run_count=run_count,seed=seed)
McSim(H, error_rate=error_rate, Decoder=bpd_v1, target_run_count=run_count,seed=seed)
